...
try:
    ...
    print(p2)
    p3 = Point(2.6, 8)
    count += 1# aquí se debe lanzar una excepción PointTypeError
    ...
    print("No ha habido errores.") if has_exited_without_problems else print("Se han producido errores, pero se ha ejecutado correctamente", count, "veces.")